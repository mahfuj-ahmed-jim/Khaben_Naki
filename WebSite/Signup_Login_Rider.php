    ...
    <div class="account-page">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h1 class="text-center" style="font-family: 'Dancing Script', cursive; right: 100%; padding-left: 200px; padding-top: 100px;">Welcome Rider! <br> Let's Ride and Earn<img src="img/Rider.svg" alt="" style=" width: 600px;">
                </div>
                    ...
                    <div class="form-container">
                        ...
                        <form id="SignupForm">
                            ...
                            <div class="form-group col-sm-4">
                                <label for="inputState" style="padding-right: 40px; padding-top: 10px;">Preferred Area</label>
                                <select id="inputState" class="form-control">
                                    <option selected>Choose...</option>
                                    <option>Rajarbag</option>
